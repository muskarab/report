    ...
    <form action="">
        ...
        <div class="row mt-3">
            <div class="input-group md-6">
                ...
                <input type="text" class="form-control" placeholder="Tempat Pertemuan" aria-label="Recipient's username" aria-describedby="basic-addon2" id="tempat" name="tempat" required>
            </div>
        </div>
        <div class="row mt-3">
